package functions.lambdaAndMethodReference;
...
public class LambdaAndMethodReferenceDemo {
    ...
    public static void main(String[] args) {
        ...
        // new way - lambda function (anonymous function)
        ...
        orderManagement.setDistanceCalculator(new GoogleDistanceCalculator()::getDistanceBetweenCities);
    }
}
...
class GoogleDistanceCalculator {
    public double getDistanceBetweenCities(City city1, City city2) { return 1; }
    public static double getDistanceBetweenCitiesStatic(City city1, City city2) { return 1; }
}
