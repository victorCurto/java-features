package functions.functionAndBifunction;
...
public class FunctionsDemoCollections {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========== Function type ( 1 parameter and 1 return ) demo ==========");
        System.out.println("map.get(4): " + map.get(4));
        map.computeIfAbsent(4, key -> Integer.toString(key)); // Lambda expression - function
        System.out.println("map.get(4): " + map.get(4));

        map.computeIfAbsent(5, FunctionsDemoCollections::convertIntToString);  //Method Reference
        System.out.println("map.get(5): " + map.get(5));



        System.out.println("========== BiFunction type( 2 parameters and 1 return value ) demo ==========");
        map.computeIfPresent(3, (key, value) -> key + " : " + value); // Lambda expression - Bifunction
        ...
        for (Product product : products) {
            ...
            //andThen => firstFunctionCall.andThen(secondFunctionCall)
            Function<Product, Double> getPriceAndThenDiscountFunction = getPriceFunction.andThen(getDiscountFunction);
            //compose => secondFunctionCall.compose(firstFunctionCall)
